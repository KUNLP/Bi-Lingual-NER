...
def parse_args():
    ...
    p.add_argument('--train', type=str, help='Path to the train data.', default='./data/ko_train.conll')
    p.add_argument('--test', type=str, help='Path to the test data.', default=None)
    p.add_argument('--dev', type=str, help='Path to the dev data.', default='./data/ko_dev.conll')
